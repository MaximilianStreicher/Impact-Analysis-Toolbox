...
%
% Script: Peak detection method for total force from loadcells
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%
%
...
file = '#bi_01_5_Krm2x-1kHz.asc';                                           % name of original input file or test name, for naming purposes
...
sel = 0.1;                                                                  % minimum magnitude difference between two consecutive detected peaks [kN/m]
hpt = 0.1;                                                                  % high pass threshold [kN/m]
dt = 1.9;                                                                   % minimum time between impacts [s] 
addpath('C:\Program Files\Matlab\ResearchR2015b\toolbox\peakfinder');       % add toolboxpath

%% LOAD DATA

Sens = dlmread([dir '\Total_force.txt'],del,skiprows,skipcol);              % read in force data from file
